...
2. It downloads `resource.zip` into the phone's Downloads location. Tencent COS is the primary source, and the remote server URL is the fallback source if the COS download fails:
   `https://your-cos-bucket.cos.ap-guangzhou.myqcloud.com/aola/assets/resource.zip`
   `http://110.40.157.248/resource.zip`
...
4. It loads the remote app page:
   `http://110.40.157.248/aola-star.html`
